...
//    		SmartDashboard.putNumber("CurrFL", followerMotor.getOutputCurrent());
    ...
    public void setSpeed(double speed)
    {
    	...
    	System.out.println(masterMotor.getDeviceID()+ " CurrM "+(side==SideOfRobot.RIGHT?"R":"L") + ": "+masterMotor.getOutputCurrent());
    	System.out.println(followerMotor.getDeviceID()+" CurrF "+(side==SideOfRobot.RIGHT?"R":"L") + ": "+followerMotor.getOutputCurrent());

    	SmartDashboard.putNumber("Curr "+masterMotor.getDeviceID(), masterMotor.getOutputCurrent());
		SmartDashboard.putNumber("Curr "+followerMotor.getDeviceID(), followerMotor.getOutputCurrent());
    }
